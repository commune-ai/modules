      ...
      <div className='mx-auto max-w-7xl space-y-6'>
        ...
        <div className='flex flex-wrap items-center justify-between gap-2 sm:gap-4'>
          ...
          <div className='flex w-full flex-wrap justify-center gap-2 sm:w-auto sm:justify-end sm:gap-4'>
            <button className='w-full rounded-xl border border-green-500/30 bg-black/90 px-6 py-3 text-center text-green-400 transition-all hover:bg-green-900/20 sm:w-auto'>
              Documentation
            </button>
            <button className='w-full rounded-xl border border-green-500/30 bg-black/90 px-6 py-3 text-center text-green-400 transition-all hover:bg-green-900/20 sm:w-auto'>
              Report Issue
